import { MOCK_DOCTORS, MOCK_APPOINTMENTS, getDoctorById, getPatientById } from '@/data/mockData';
...
    return MOCK_APPOINTMENTS.filter(a => a.doctorId === doctorId).sort((x,y) => new Date(x.startTime).getTime() - new Date(y.startTime).getTime());
  }
